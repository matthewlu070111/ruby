...
public class FoodCookedRubyApple extends ItemFood implements IHasModel {
	public FoodCookedRubyApple(String name, int amount, float saturation, boolean isWolfFood) {
