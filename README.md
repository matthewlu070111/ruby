# Ruby
#### You can goto [MCBBS][mcbbslink] to download(The page use Chinese).
#### You can goto [My Home Page][homeruby] to download(The page use Chinese).
#### You can goto [BaiduYunDisk][bdyp] to download(The page use Chinese).Code:UP08
#### You can goto [Curseforge][curseforge] to download(The page use English).
